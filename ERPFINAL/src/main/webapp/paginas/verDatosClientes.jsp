<%-- 
    ...
    Created on : 14-jul-2021, 20:12:49
    Author     : diego
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 pt-2">
                                <div class="col-12 pt-2" style=" width: auto; height: auto;"> 
                                    <div class="h3 rounded" style="background:#F29C46; border: 1px solid black;">Datos de Clientes</div>
                                    <div class="table-responsive">
                                        <table class="table  table-bordered table-sm" style="border: 1px solid black;">
                                            <thead class="table-dark">
                                                <tr>
                                                    <th colspan="5"> Mantemiento</th>
                                                    <th><a href="agregarCliente.jsp">
                                            ...
                                            <tbody style="border-color: black; background: white;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editarCliente.jsp?rut=<%=rs.getString(1)%>">
