<%-- 
    Document   : visualizarFacturas
    Created on : 14-jul-2021, 19:57:05
    Author     : diego
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 pt-2"> 
                                <div class="col-12 pt-2" style=" width: auto; height: auto;"> 
                                    <div class="h3 rounded" style="background:#F29C46; border: 1px solid black;">Facturas</div>
                                    <div class="table-responsive">
                                        <table class="table  table-bordered table-sm" style="border: 1px solid black;">
                                            <thead class="table-dark">
                                                <tr>
                                                    <th colspan="8"> Mantemiento</th>
                                                    <th><a href="agregarFactura.jsp">
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    rs = sta.executeQuery("select * from factura");
                                            ...
                                            <tbody style="border-color: black; background: white;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editarFactura.jsp?rut=<%=rs.getString(1)%>">
                                                            <img src="iconos/editar.png" style="width: 25px; height: 25px;"> ||
                                                        </a>
                                                        <a href="eliminarFactura.jsp?rut=<%=rs.getString(1)%>">
