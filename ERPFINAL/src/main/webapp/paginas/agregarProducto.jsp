<%-- 
    ...
    Created on : 14-jul-2021, 19:55:39
    Author     : diego
--%>
                            ...
                            <div class="col-12 pt-2">
                                <div class="col-12 pt-2"> 
                                    <div class="container-fluid p-5">
                                        <form action="">
                                            <h3 class="p-2">Agregar Producto</h3>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="txtIDCategoria" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="inputGroup-sizing-default">Descripcion del producto</span>
                                                <input type="text" name="txtDescripcionProducto" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="inputGroup-sizing-default">Nombre del producto</span>
                                                <input type="text" name="txtNombreProducto" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="inputGroup-sizing-default">Precio</span>
                                                <input type="text" name="txtPrecio" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="inputGroup-sizing-default">Stock del producto</span>
                                                <input type="text" name="txtStockProducto" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
                                            <div class="col-12">
                                        ...
                                        <%
                                            ...
                                            sta.executeUpdate("insert into productos values("+idpro+","+idcat+",'"+desc+"','"+nom+"',"+pre+","+sto+")");
