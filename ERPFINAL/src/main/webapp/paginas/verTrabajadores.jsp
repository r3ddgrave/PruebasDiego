<%-- 
    Document   : listadeVendedores
    Created on : 14-jul-2021, 20:02:56
    Author     : diego
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 pt-2">
                                <div class="col-12 pt-2" style="width: auto; height: auto; "> 
                                    <div class="h3 rounded" style="background:#F29C46; border: 1px solid black;">Trabajadores</div>
                                    <div class="table-responsive">
                                        <table class="table  table-bordered table-sm" style="border: 1px solid black;">
                                            <thead class="table-dark">
                                                <tr>
                                                    <th colspan="4"> Mantemiento</th>
                                                    <th><a href="agregarTrabajador.jsp">
                                                        <img src="iconos/agregarr.png" style="width: 30px; height: 30px;"></a></th>
                                                </tr>
                                                <tr>
                                                    <th>ID Trabajador</th>
                                                    <th>ID rol del trabajador</th>
                                                    <th>Nombre</th>
                                                    <th>Apellido</th>
                                                    <th>Action</th>
                                                </tr>
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    rs = sta.executeQuery("select * from trabajador");
                                            ...
                                            <tbody style="border-color: black; background: white;">
                                                <tr>
                                                    ...
                                                    <td><a href="editarTrabajador.jsp?rut=<%=rs.getString(1)%>">
                                                        <img src="iconos/editar.png" style="width: 25px; height: 25px;"> ||
                                                        </a>
                                                        <a href="eliminarCliente.jsp?rut=<%=rs.getString(1)%>">
